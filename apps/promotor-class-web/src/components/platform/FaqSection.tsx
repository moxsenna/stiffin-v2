...
export function FaqSection() {
  const faqs = [
    {
      q: 'Apakah saya membutuhkan keahlian teknis atau koding untuk menggunakan Ralivo Class?',
    ...
    {
      q: 'Mengapa Ralivo Class lebih efektif dibanding membagikan link Google Drive atau grup WhatsApp?',
      a: 'Link Google Drive sering hilang di riwayat chat, dan Anda tidak tahu apakah peserta benar-benar menontonnya. Di grup WhatsApp, peserta pasif cenderung diam. Ralivo Class memberikan ruang belajar mandiri yang rapi, mencatat progres belajar, dan memicu refleksi aktif sehingga peserta merasa terikat dengan materi Anda.',
    },
    {
    ...
    {
      q: 'Apakah saya bisa menggunakan Ralivo Class untuk program pendampingan aftersales tes STIFIn?',
      a: 'Ya, ini salah satu keunggulan utama Ralivo Class. Anda dapat membuat program "30 Hari Pendampingan Pasca Tes" yang hanya bisa diakses oleh klien yang sudah melakukan tes, sehingga mereka mendapatkan panduan bertahap dan merasakan nilai maksimal dari sesi konsultasi Anda.',
    },
  ];
