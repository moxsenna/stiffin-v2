    ...
    >
      <div className="container">
        ...
        >
          ...
          >
            Ralivo Class adalah <strong>Client Education OS</strong> yang mengubah video ringkas dan materi pengantar Anda menjadi sinyal niat beli, onboarding aftersales terstruktur, dan tindak lanjut WhatsApp siap closing.
          </p>
