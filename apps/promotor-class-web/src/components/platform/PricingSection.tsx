  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
        <div style={{ maxWidth: '780px', margin: '0 auto 32px', textAlign: 'center' }}>
          <div
            style={{
              fontSize: '12px',
              fontWeight: 800,
        ...
        {billingCycle === 'monthly' ? (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', minWidth: 0 }}>
              ...
              <div style={{ fontSize: '13.5px', color: '#713F12', lineHeight: 1.5 }}>
                ...
                Upsell Paket Lengkap (Class + Flow) di opsi tahunan <strong>cukup tambah Rp 200.000/tahun</strong> (bukan 12 × Rp 50.000 = Rp 600.000). Total Anda hemat <strong>Rp 598.000/tahun</strong>!
              </div>
            </div>
            <button
              type="button"
          ...
          >
            ...
            <div style={{ fontSize: '13.5px', color: '#1E40AF', lineHeight: 1.5 }}>
              <strong style={{ color: '#1D4ED8', fontWeight: 800 }}>Tarif Super Hemat Tahunan Aktif:</strong> Paket Lengkap Class + Flow hanya <strong>Rp 1.190.000/tahun</strong> (setara ~Rp 99.000/bln). Anda menghemat <strong>Rp 598.000</strong> per tahun!
            </div>
          </div>
        )}
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '4px', flexWrap: 'wrap' }}>
                {billingCycle === 'annual' && includeUpsell && (
                  <span style={{ fontSize: '18px', fontWeight: 600, color: 'var(--color-text-muted)', textDecoration: 'line-through' }}>
                    Rp 1.788.000
                  </span>
                )}
                ...
                {billingCycle === 'annual' && includeUpsell && (
                  <span style={{ fontSize: '11.5px', fontWeight: 800, color: '#1E40AF', backgroundColor: '#DBEAFE', padding: '2px 8px', borderRadius: '6px' }}>
                    Hemat Rp 598.000
                  </span>
                )}
              </div>
              <div style={{ fontSize: '11.5px', color: 'var(--color-text-muted)', marginBottom: '14px' }}>
                {includeUpsell ? (
                  billingCycle === 'annual'
                    ? 'Rp 990.000 (Class) + Rp 200.000 (Flow Upsell — Hemat Rp 400.000!)'
                    : 'Rp 99.000 (Class) + Rp 50.000 (Flow Upsell) · Batal kapan saja'
                ) : (
                  billingCycle === 'annual'
