      ...
      <div style={{ width: '100%', maxWidth: 360 }}>
        ...
        <div style={{ background: 'var(--surface)', border: 'var(--sep-strong)', padding: 22 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label className="field-label" htmlFor="class-new-password">Kata sandi baru</label>
              <input
                id="class-new-password"
                type="password"
                required
            ...
            <div>
              <label className="field-label" htmlFor="class-confirm-password">Konfirmasi kata sandi</label>
              <input
                id="class-confirm-password"
                type="password"
                required
                autoComplete="new-password"
                minLength={8}
