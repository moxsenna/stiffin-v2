...
CREATE TABLE "contacts" (
	...
	CONSTRAINT "contacts_phone_e164_format" CHECK ("contacts"."phone_e164" IS NULL OR "contacts"."phone_e164" ~ '^\+[1-9][0-9]{1,14}$')
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "contacts_org_phone_unique" ON "contacts" USING btree ("organization_id","phone_e164") WHERE "contacts"."phone_e164" IS NOT NULL;--> statement-breakpoint
