...
description: >
  ...
  accent, the three-step gray text ladder, Archivo (display/numerals/chrome) + Archivo (body),
...
typography:
  # — reading ramp (Archivo body + Archivo chrome) —
  body:    { fontFamily: "Archivo", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Archivo", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Archivo", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Archivo", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Archivo, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Archivo", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Archivo", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Archivo", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Archivo", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Archivo", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Archivo", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Archivo", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Archivo** (display) / **system-ui** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Archivo** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Archivo** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Archivo** (display/numerals/chrome) + **Archivo** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Archivo body 0.85cqw muted; Archivo eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Archivo `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Archivo 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Archivo `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Archivo label + muted desc + optional
...
blockquote, cite. **Focal** a Archivo `blockquote` near-black under a 15%-opacity cobalt
...
Archivo body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Archivo `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Archivo 400 muted, line 1.6.
...
- **Type** — Archivo headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Archivo body muted line 1.6; ≥1.4cqw floor.
...
- **Archivo + Archivo via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
